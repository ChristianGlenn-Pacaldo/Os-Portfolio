    ...
    <div className={`transition-all ${navBg ? 'bg-[#0f142ed9] shadow-md':'fixed'} duration-200 h-[12vh] z-[10000] fixed w-full`}>
      <div className='flex items-center h-full justify-between w-[90%] mx-auto'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <h1 className='text-xl hidden sm:block md:text-2xl text-white font-bold'>GLENN</h1>
        </div>
        ...
        <div className='flex items-center space-x-4'>
            { /* CHANGED: Swapped <button> for <a> to enable download */ }
            <a 
                href="/GlennResume.pdf" 
                download="GlennResume.pdf" 
