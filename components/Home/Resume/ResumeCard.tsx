...
const ResumeCard = ({ Icon, role, date }: Props) => {
    return <div className='mb-6 '>
        ...
        <div className='flex-1'>
            ...
            <p className='text-gray-300 text-sm sm:text-base pt-3 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus veritatis corrupti nulla amet aspernatur doloribus non earum delectus quos! Illo error amet ex quos harum dolores mollitia voluptatibus expedita cumque!</p>
        </div>
        </div>
    </div>
}
