...
const Contact = () => {
  return <div id='contact' className='pt-16 pb-16'>
    <div className='w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
        {/* Contact Info */}
        <div>
            <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-200'>
                Schedule a call with me too see if I can help
            </h1>
            ...
            <div className='flex items-center mt-8 space-x-3'>
                <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center cursor-pointer flex-col hover:bg-blue-800 transition-all duration-300'>
                    <a href='https://www.facebook.com/itsme.nahce'>
                    <FaFacebookF className='w-6 h-6 text-white' /></a>
                </div>
                <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center cursor-pointer flex-col hover:bg-red-600 transition-all duration-300'>
                    <a href='https://www.youtube.com/@cordovavines'>
                ...
                <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center cursor-pointer flex-col hover:bg-sky-400 transition-all duration-300'>
                    <a href='https://x.com/ShisuiHyosube'>
                ...
                <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center cursor-pointer flex-col hover:bg-pink-500 transition-all duration-300'>
                    <a href='https://www.instagram.com/allabout.glenn?igsh=MXEwNHk1aTlseTFhaw=='>
        ...
        >
            ...
            <input type="email" placeholder='Email' className='mt-6 px-4 py-3.5 bg-[#363659] text-white outline-none rounded-md w-full placeholder:text-white/70'/>
            <input type="number" placeholder='Mobile Number' className='mt-6 px-4 py-3.5 bg-[#363659] text-white outline-none rounded-md w-full placeholder:text-white/70'/>
            <textarea placeholder='Your Message'
            className='mt-6 px-4 py-3.5 bg-[#363659] text-white outline-none rounded-md w-full placeholder:text-white/70 h-[10rem]'>   
            </textarea>
